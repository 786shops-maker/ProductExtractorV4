...
CASCADE_FILE = cv2.data.haarcascades + \
...
class ImageProcessor:
    ...
    def chin_y(self, face):
        ...
        # Chin approximately 90% down the face
        return int(y + h * 0.90)
    ...
    def process(
        ...
        output_folder = Path(output_folder) / "temp_images" / safe_brand
        ...
        image_files = self.remove_duplicate_files(
        ...
        for filename in image_files:
            ...
            try:
                ...
                image = self.crop_below_chin(

                    image

                )

                image = self.best_resize(
                ...
                outfile = output_folder / (
                    ...
                    f"{safe_brand}-{product_id}-z{count}.jpg"
